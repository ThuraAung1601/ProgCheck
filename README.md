...
Run an interactive UI that provides:
- large editor pane (left half)
- right half split into question / test query input / feedback
- closable query + feedback panels
- resizable split panes
- syntax check, custom query trace/proof, LLM feedback, visualization popup,
  and full diagnosis with auto-correct diff accept/deny.

```bash
pip install -r requirements.txt
uvicorn webui.main:app --reload --app-dir .
```
