...
# python check_prolog.py --problem examples/factorial_problem.txt --student_code student_codes/factorial_no_base.pl --output outputs/factorial_no_base.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/factorial_no_base_fixed.pl
# python check_prolog.py --problem examples/factorial_problem.txt --student_code student_codes/factorial_wrong_base.pl --output outputs/factorial_wrong_base.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/factorial_wrong_base_fixed.pl
# python check_prolog.py --problem examples/factorial_problem.txt --student_code student_codes/factorial_swapped_args.pl --output outputs/factorial_swapped_args.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/factorial_swapped_args_fixed.pl
# python check_prolog.py --problem examples/factorial_problem.txt --student_code student_codes/factorial_arity_mismatch.pl --output outputs/factorial_arity_mismatch.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/factorial_arity_mismatch_fixed.pl
# # Syntax error cases
...
python check_prolog.py --problem examples/cut_max_problem.txt --student_code student_codes/cut_correct.pl --output outputs/cut_correct.txt
python check_prolog.py --problem examples/cut_max_problem.txt --student_code student_codes/cut_missing_cut.pl --output outputs/cut_missing_cut.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/cut_missing_cut_fixed.pl
...
python check_prolog.py --problem examples/cut_max_problem.txt --student_code student_codes/cut_wrong_position.pl --output outputs/cut_wrong_position.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/cut_wrong_position_fixed.pl
python check_prolog.py --problem examples/cut_max_problem.txt --student_code student_codes/cut_no_fallback.pl --output outputs/cut_no_fallback.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/cut_no_fallback_fixed.pl
python check_prolog.py --problem examples/cut_max_problem.txt --student_code student_codes/cut_swapped_result.pl --output outputs/cut_swapped_result.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/cut_swapped_result_fixed.pl
python check_prolog.py --problem examples/cut_max_problem.txt --student_code student_codes/cut_over_cut.pl --output outputs/cut_over_cut.txt --auto_fix --max_fix_attempts 2 --fix_output outputs/cut_over_cut_fixed.pl
